...
import javax.swing.border.LineBorder;
 ...
 public class JFontViewer {
    ...
    JFontViewer()
    {
        ...
        fonts.setAlignmentX(JComponent.LEFT_ALIGNMENT);
        fonts.setSize(50,50);
        ...
        /**fontList.addListSelectionListener(ll ->
        {
            if(ll.getValueIsAdjusting())
            {
                fontName = fontList.getSelectedValue();
                text.setFont(new Font(
                    text.getFont().getSelectedValue(),
                    text.getFont().getStyle(),
                    horzSlider.getValue()
                    ));
            }
        ...
        */
        // Edit preview text when font is clicked.
        ...
        effects.setDisplayedMnemonic('E');
